...
interface MapViewPropertyProps {
    selectedLocation?: { latitude: number; longitude: number } | null;
    onLocationSelect?: (latitude: number, longitude: number) => void;
    style?: any;
}

// Componente para seleccionar una ubicación (para crear posts)
function MapViewPropertyMobile({
    selectedLocation,
    onLocationSelect,
    style,
...
export default function MapViewProperty(props: MapViewPropertyProps) {
    console.log('MapViewProperty - Props recibidos:', {
        selectedLocation: props.selectedLocation,
    });

    return <MapViewPropertyMobile {...props} />;
}
