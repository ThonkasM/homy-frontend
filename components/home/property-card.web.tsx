...
const PropertyCard = React.memo(({
    ...
    const styles = createStyles(isMobile, width);
                ...
                <View style={styles.imageOverlay}>
                    ...
                    <View style={styles.propertyOverlayContent}>
                        ...
                        <Text style={styles.propertyMeta}>
                            <MaterialCommunityIcons name="map-marker" size={16} color="#ffffff" /> {property.city} • {property.address}
                        </Text>
                    </View>
                </View>
            </TouchableOpacity>
...
const createStyles = (isMobile: boolean, screenWidth: number) => {
    ...
    return StyleSheet.create({
        ...
        actionButtons: {
            flexDirection: 'row',
            paddingHorizontal: isVerySmall ? 8 : isMobile ? 12 : 16,
            paddingVertical: isVerySmall ? 10 : isMobile ? 12 : 20,
        ...
        actionButton: {
            flex: 1,
            paddingVertical: isVerySmall ? 8 : isMobile ? 10 : 14,
            paddingHorizontal: isVerySmall ? 4 : isMobile ? 8 : 12,
            borderRadius: 12,
            justifyContent: 'center',
            alignItems: 'center',
            gap: isVerySmall ? 2 : isMobile ? 4 : 8,
            flexDirection: 'row',
            shadowColor: '#000',
            shadowOffset: { width: 0, height: 2 },
            shadowOpacity: 0.08,
        ...
        actionButtonText: {
            ...
            color: '#ffffff',
            letterSpacing: 0.3,
            marginLeft: isVerySmall ? 1 : isMobile ? 2 : 4,
        },
    });
};
