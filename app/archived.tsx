...
export default function ArchivedScreen() {
    ...
    const { properties, loading, fetchUserProperties, publishProperty } = useProperties();
    const [refreshing, setRefreshing] = useState(false);

    // Filtrar propiedades con postStatus: ARCHIVED
    const archivedProperties = properties.filter((p: any) => p.postStatus === 'ARCHIVED');
    ...
    const handleRefresh = async () => {
        ...
        try {
            ...
            console.error('Error refreshing archived:', err);
        } finally {
            setRefreshing(false);
        }
    };
    ...
    const handlePublishProperty = (propertyId: string, title: string) => {
        Alert.alert(
            'Publicar Propiedad',
            `¿Deseas publicar "${title}" nuevamente?`,
            [
        ...
        <SafeAreaView style={styles.safeContainer}>
            ...
            >
                ...
                <View style={styles.headerContainer}>
                    ...
                    <Text style={styles.headerTitle}>Archivados</Text>
                    <View style={{ width: 40 }} />
                </View>
                ...
                {loading ? (
                    ...
                    <View style={styles.listContainer}>
                        {archivedProperties.map((property: any) => (
                            <View key={property.id} style={styles.propertyCard}>
                                ...
                                >
                                    ...
                                    <Text style={styles.propertyStatus}>📦 Archivado</Text>
                                </TouchableOpacity>
                    ...
                    <View style={styles.emptyContainer}>
                        ...
                        <Text style={styles.emptyText}>No tienes propiedades archivadas</Text>
                        <Text style={styles.emptySubtext}>Las propiedades que arquives aparecerán aquí</Text>
                    </View>
                )}
            </ScrollView>
        </SafeAreaView>
